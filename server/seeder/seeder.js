...
module.exports = async () => {
    ...
    const users = await User.bulkCreate([
        ...
        },
        {
            ...
            nickname: null,
            profile_img_url: "http://www.tinygraphs.com/spaceinvaders/tinygraphs?theme=summerwarmth&numcolors=3&size=220&fmt=svg"
        },
        {
            nickname: "SeungJin-Woo",
            github_id: "woo123",
            profile_img_url: "http://www.tinygraphs.com/labs/isogrids/hexa16/tinygraphs?theme=berrypie&numcolors=3&size=220&fmt=svg"
        },
        {
            nickname: "JeongHyun-Son",
            github_id: "woo123",
            profile_img_url: "http://tinygraphs.com/squares/tinygraphs?theme=frogideas&numcolors=4&size=220&fmt=svg"
        },
    ]);
